...
import pepse.Bonus.GraphicLifeCounter;
...
public class Avatar extends GameObject {
    ...
    /**
     * Creates an instance of the Avatar class if it does not already exist, and adds it to a GameObjectCollection
     * object.
     * If the instance already exists, it returns the existing instance.
     *
     * @param gameObjects    an instance of the GameObjectCollection class, used to add the created avatar
     *                       object to the collection.
     * @param layer          an int value representing the layer on which the avatar object should be added.
     * @param topLeftCorner  a Vector2 object representing the top-left corner position of the avatar object.
     * @param inputListener  an instance of UserInputListener class, used to handle user input.
     * @param imageReader    an instance of ImageReader class, used to read images.
     *
     * @return an instance of the Avatar class.
     */
     ...
     * @return should avatar collide with other
     */
    @Override
