...
public class Sun {
    ...
    /**
     * Creates Sun Object and adds it to the GameObject.
     ...
     * @param cycleLength Cycle Length of Sun's lifetime.
     * @return
     */
    public static GameObject create(
        ...
        new Transition<Float>(sun,
                angle -> sun.setCenter(centerVector.add(centerVector.multX((float) Math.cos(angle)).multY((float)
                        Math.sin(-angle))))
                ,pi/2,
