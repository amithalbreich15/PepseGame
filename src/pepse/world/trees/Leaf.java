...
public class Leaf extends GameObject {
    ...
    private static final float INITIAL_ANGLE = 4f;
    ...
    /**
     * Create schedule task of leaf's creation.
     */
    ...
    /**
     * Sets the leaf renderable with the given transitions.
     */
    private void setLeafRend(){

        new Transition<Float>(this,
                this.renderer()::setRenderableAngle,
                INITIAL_ANGLE, -INITIAL_ANGLE, Transition.CUBIC_INTERPOLATOR_FLOAT,
    ...
    /**
     * Scheduled Task for leaf disappearance Animation.
     */
    ...
    /**
     * reat schedual task of leaf fall
     */
